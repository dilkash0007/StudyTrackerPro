...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative">
      ...
      <div className="absolute top-1/4 -left-24 w-64 h-64 bg-cyan-500/5 rounded-full blur-3xl"></div>
      <div className="absolute bottom-1/4 -right-24 w-64 h-64 bg-teal-500/5 rounded-full blur-3xl"></div>
      ...
      <Card className="w-full max-w-md relative overflow-hidden backdrop-blur-sm bg-gray-900/50 border-teal-500/30">
        ...
        <CardHeader className="space-y-1">
          ...
          <CardDescription className="text-center text-gray-400">
            Connect to your TaskTrackerPro account
          </CardDescription>
        </CardHeader>
          ...
          <div className="text-sm text-center text-gray-400 flex items-center justify-center">
            ...
            <Link to="/register">
              <a className="text-teal-400 hover:text-teal-300 ml-1 flex items-center">
                Sign up <PulsingDot className="ml-1" />
              </a>
            </Link>
          </div>
        </CardFooter>
